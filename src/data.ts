...
export const projects = [
  ...
  {n:'02',title:'HealthIO',type:'HEALTHCARE AI / FULL-STACK',desc:'An AI-powered personal health record and medication management platform connecting doctors, patients and caregivers across clinical visits, digital prescriptions, lab tests, smart reminders and treatment adherence tracking with verified AI advisory guardrails.',tech:['FastAPI','React','TypeScript','PostgreSQL','Docker','Celery'],image:healthioImage,logo:healthioImage,github:'https://github.com/sourav7-1/HealthIO'},
  ...
  {n:'04',title:'Distributed Campus AI Compute',type:'DISTRIBUTED SYSTEMS',desc:'An architecture concept for pooling approved CPU and GPU resources across separate physical locations into a single usable compute layer for AI workloads.',tech:['Python','Docker','Distributed Compute']},
  {n:'05',title:'Street Food Safety Platform',type:'DATA / WEB PLATFORM',desc:'A structured platform for tracking street-food vendor inspections end to end — logging complaints, scoring hygiene results and recording the corrective actions that follow.',tech:['Flask','MySQL','SQLAlchemy'],github:'https://github.com/sourav7-1/Food-Safety-System'},
