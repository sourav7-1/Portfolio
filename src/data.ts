...
export const projects = [
  ...
  {n:'06',title:'FocusFlow',type:'PRODUCTIVITY PLATFORM',desc:'Study sessions, tasks, goals and secure account workflows brought into one Laravel application.',tech:['Laravel','PHP','Blade','SQL'],image:'/assets/projects/focusflow-dashboard.png',github:'https://github.com/sourav7-1/focusflow'}
];
